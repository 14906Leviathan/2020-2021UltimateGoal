...
public class HardwareProfile {
    ...
    public DcMotor motorWobbleArm = null;  // Right Rear Drive Motor
...
//        public DcMotor horizontalOdometry = null;
    ...
    public void init(HardwareMap ahwMap) {
        ...
        motorWobbleArm = hwMap.dcMotor.get("motorWobbleArm");
        motorWobbleArm.setDirection(DcMotor.Direction.FORWARD);
        motorWobbleArm.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        motorWobbleArm.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        motorWobbleArm.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        motorWobbleArm.setPower(0);
